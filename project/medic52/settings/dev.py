...
RAVEN_CONFIG = {
    'dsn': 'http://bf692609485343889dabfa171f9a7232:cc1ae1e6098f4160afa9074d03168b2e@sentry.medic52.com/2',
    'site': 'Medic52 Dev'
}
...
SENDFILE_ROOT = os.path.join(MEDIA_ROOT, 'media', 'media')
SENDFILE_URL = '/media'
