...
STATIC_ROOT = '/data/www/api.medic52.com/static'

TEMPLATE_DIRS += (os.path.join(STATIC_ROOT, 'content'),)

MEDIA_ROOT = '/data/www/api.medic52.com'
...
RAVEN_CONFIG = {
    'dsn': 'http://185a3ffccce14e36bf39d01721700815:da374087313a45519f7f654ea9b10577@sentry.medic52.com/4',
    'site': 'Medic52 Master'
}
