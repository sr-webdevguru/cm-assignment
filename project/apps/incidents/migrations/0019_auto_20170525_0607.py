...
def fix_radio_buttons(apps, schema_editor):
    ...
    IncidentTemplate = apps.get_model('incidents', 'IncidentTemplate')
    for incident_template in IncidentTemplate.objects.all():
        incident_template.json = json_template
        incident_template.save()
    return

class Migration(migrations.Migration):

    dependencies = [
        ('incidents', '0018_incidentaudit_prev_assigned_to'),
    ]
