...
class Migration(migrations.Migration):
    dependencies = [
        ('resorts', '0022_auto_20151124_1027'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, max_length=50,
                                   choices=[(b'Africa/Abidjan', b'Africa/Abidjan'), (b'Africa/Accra', b'Africa/Accra'),
                                            ...
                                            (b'Africa/Ceuta', b'Africa/Ceuta'), (b'Africa/Conakry', b'Africa/Conakry'),
                                            ...
                                            (b'Africa/Juba', b'Africa/Juba'), (b'Africa/Kampala', b'Africa/Kampala'),
                                            ...
                                            (b'Africa/Lusaka', b'Africa/Lusaka'), (b'Africa/Malabo', b'Africa/Malabo'),
                                            (b'Africa/Maputo', b'Africa/Maputo'), (b'Africa/Maseru', b'Africa/Maseru'),
                                            ...
                                            (b'Africa/Tripoli', b'Africa/Tripoli'), (b'Africa/Tunis', b'Africa/Tunis'),
                                            ...
                                            (b'America/Atka', b'America/Atka'), (b'America/Bahia', b'America/Bahia'),
                                            ...
                                            (b'Asia/Aden', b'Asia/Aden'), (b'Asia/Almaty', b'Asia/Almaty'),
                                            (b'Asia/Amman', b'Asia/Amman'), (b'Asia/Anadyr', b'Asia/Anadyr'),
                                            (b'Asia/Aqtau', b'Asia/Aqtau'), (b'Asia/Aqtobe', b'Asia/Aqtobe'),
                                            ...
                                            (b'Asia/Kuching', b'Asia/Kuching'), (b'Asia/Kuwait', b'Asia/Kuwait'),
                                            (b'Asia/Macao', b'Asia/Macao'), (b'Asia/Macau', b'Asia/Macau'),
                                            (b'Asia/Magadan', b'Asia/Magadan'), (b'Asia/Makassar', b'Asia/Makassar'),
                                            (b'Asia/Manila', b'Asia/Manila'), (b'Asia/Muscat', b'Asia/Muscat'),
                                            (b'Asia/Nicosia', b'Asia/Nicosia'),
                                            (b'Asia/Novokuznetsk', b'Asia/Novokuznetsk'),
                                            (b'Asia/Novosibirsk', b'Asia/Novosibirsk'), (b'Asia/Omsk', b'Asia/Omsk'),
                                            (b'Asia/Oral', b'Asia/Oral'), (b'Asia/Phnom_Penh', b'Asia/Phnom_Penh'),
                                            ...
                                            (b'Asia/Samarkand', b'Asia/Samarkand'), (b'Asia/Seoul', b'Asia/Seoul'),
                                            ...
                                            (b'CET', b'CET'), (b'CST6CDT', b'CST6CDT'),
                                            ...
                                            (b'Chile/EasterIsland', b'Chile/EasterIsland'), (b'Cuba', b'Cuba'),
                                            (b'EET', b'EET'), (b'EST', b'EST'), (b'EST5EDT', b'EST5EDT'),
                                            (b'Egypt', b'Egypt'), (b'Eire', b'Eire'), (b'Etc/GMT', b'Etc/GMT'),
                                            (b'Etc/GMT+0', b'Etc/GMT+0'), (b'Etc/GMT+1', b'Etc/GMT+1'),
                                            (b'Etc/GMT+10', b'Etc/GMT+10'), (b'Etc/GMT+11', b'Etc/GMT+11'),
                                            (b'Etc/GMT+12', b'Etc/GMT+12'), (b'Etc/GMT+2', b'Etc/GMT+2'),
                                            (b'Etc/GMT+3', b'Etc/GMT+3'), (b'Etc/GMT+4', b'Etc/GMT+4'),
                                            (b'Etc/GMT+5', b'Etc/GMT+5'), (b'Etc/GMT+6', b'Etc/GMT+6'),
                                            (b'Etc/GMT+7', b'Etc/GMT+7'), (b'Etc/GMT+8', b'Etc/GMT+8'),
                                            (b'Etc/GMT+9', b'Etc/GMT+9'), (b'Etc/GMT-0', b'Etc/GMT-0'),
                                            (b'Etc/GMT-1', b'Etc/GMT-1'), (b'Etc/GMT-10', b'Etc/GMT-10'),
                                            ...
                                            (b'Etc/GMT0', b'Etc/GMT0'), (b'Etc/Greenwich', b'Etc/Greenwich'),
                                            ...
                                            (b'Europe/Kiev', b'Europe/Kiev'), (b'Europe/Lisbon', b'Europe/Lisbon'),
                                            ...
                                            (b'Europe/Minsk', b'Europe/Minsk'), (b'Europe/Monaco', b'Europe/Monaco'),
                                            ...
                                            (b'Europe/Skopje', b'Europe/Skopje'), (b'Europe/Sofia', b'Europe/Sofia'),
                                            ...
                                            (b'Europe/Warsaw', b'Europe/Warsaw'), (b'Europe/Zagreb', b'Europe/Zagreb'),
                                            (b'Europe/Zaporozhye', b'Europe/Zaporozhye'),
                                            (b'Europe/Zurich', b'Europe/Zurich'), (b'GB', b'GB'),
                                            (b'GB-Eire', b'GB-Eire'), (b'GMT', b'GMT'), (b'GMT+0', b'GMT+0'),
                                            (b'GMT-0', b'GMT-0'), (b'GMT0', b'GMT0'), (b'Greenwich', b'Greenwich'),
                                            (b'HST', b'HST'), (b'Hongkong', b'Hongkong'), (b'Iceland', b'Iceland'),
                                            (b'Indian/Antananarivo', b'Indian/Antananarivo'),
                                            (b'Indian/Chagos', b'Indian/Chagos'),
                                            (b'Indian/Christmas', b'Indian/Christmas'),
                                            (b'Indian/Cocos', b'Indian/Cocos'), (b'Indian/Comoro', b'Indian/Comoro'),
                                            ...
                                            (b'Israel', b'Israel'), (b'Jamaica', b'Jamaica'), (b'Japan', b'Japan'),
                                            (b'Kwajalein', b'Kwajalein'), (b'Libya', b'Libya'), (b'MET', b'MET'),
                                            (b'MST', b'MST'), (b'MST7MDT', b'MST7MDT'),
                                            (b'Mexico/BajaNorte', b'Mexico/BajaNorte'),
                                            (b'Mexico/BajaSur', b'Mexico/BajaSur'),
                                            (b'Mexico/General', b'Mexico/General'), (b'NZ', b'NZ'),
                                            (b'NZ-CHAT', b'NZ-CHAT'), (b'Navajo', b'Navajo'), (b'PRC', b'PRC'),
                                            (b'PST8PDT', b'PST8PDT'), (b'Pacific/Apia', b'Pacific/Apia'),
                                            ...
                                            (b'Poland', b'Poland'), (b'Portugal', b'Portugal'), (b'ROC', b'ROC'),
                                            (b'ROK', b'ROK'), (b'Singapore', b'Singapore'), (b'Turkey', b'Turkey'),
                                            (b'UCT', b'UCT'), (b'US/Alaska', b'US/Alaska'),
                                            (b'US/Aleutian', b'US/Aleutian'), (b'US/Arizona', b'US/Arizona'),
                                            (b'US/Central', b'US/Central'), (b'US/East-Indiana', b'US/East-Indiana'),
                                            (b'US/Eastern', b'US/Eastern'), (b'US/Hawaii', b'US/Hawaii'),
                                            ...
                                            (b'US/Samoa', b'US/Samoa'), (b'UTC', b'UTC'), (b'Universal', b'Universal'),
