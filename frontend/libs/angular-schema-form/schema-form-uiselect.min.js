angular.module("schemaForm").run(["$templateCache", function (e) {
...
}]), angular.module("schemaForm-uiselect", ["schemaForm", "ui.select"]).config(["schemaFormProvider", "schemaFormDecoratorsProvider", "sfPathProvider", function (e, r, t) {
    var s = function (r, s, l) {
        if ("string" === s.type && "uiselect" == s.format) {
            var o = e.stdFormObj(r, s, l);
            return o.key = l.path, o.type = "uiselect", l.lookup[t.stringify(l.path)] = o, o
        }
    };
    e.defaults.string.unshift(s);
    var s = function (r, s, l) {
        if ("number" === s.type && "uiselect" == s.format) {
            var o = e.stdFormObj(r, s, l);
            return o.key = l.path, o.type = "uiselect", l.lookup[t.stringify(l.path)] = o, o
        }
    };
    e.defaults.number.unshift(s);
    var l = function (r, s, l) {
        if ("array" === s.type && "uiselect" == s.format) {
            var o = e.stdFormObj(r, s, l);
            return o.key = l.path, o.type = "uimultiselect", l.lookup[t.stringify(l.path)] = o, o
        }
    };
    e.defaults.array.unshift(l), r.addMapping("bootstrapDecorator", "uiselect", "directives/decorators/bootstrap/uiselect/single.html"), r.createDirective("uiselect", "directives/decorators/bootstrap/uiselect/single.html"), r.addMapping("bootstrapDecorator", "uimultiselect", "directives/decorators/bootstrap/uiselect/multi.html"), r.createDirective("uimultiselect", "directives/decorators/bootstrap/uiselect/multi.html")
}]).directive("toggleSingleModel", function () {
    return{require: "ngModel", restrict: "A", scope: {}, replace: !0, controller: ["$scope", function (e) {
    ...
    return{require: "ngModel", restrict: "A", scope: {}, replace: !0, controller: ["$scope", function (e) {
        e.$parent.$watch("form.select_models", function () {
    ...
    return function (e, r, t) {
        var s = [];
        return angular.isArray(t) ? t.forEach(function (t) {
            for (var l = 0; l < e.length; l++)if (t == e[l][r]) {
                s.push(e[l]);
                break
            }
        }) : s = e, s
    ...
    return function (e, r) {
        ...
        return angular.isArray(e) ? e.forEach(function (e) {
            for (var s = !1, l = Object.keys(r), o = 0; o < l.length; o++) {
                var a = l[o], c = r[a].toLowerCase();
                if (-1 !== e[a].toString().toLowerCase().indexOf(c)) {
                    s = !0;
                    break
                }
            }
